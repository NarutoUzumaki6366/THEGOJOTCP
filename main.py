        ...
        fields = {
            ...
            2: {   # data
                ...
                9: {    # field9 - player details
                    1: "[C][B][FF0000] ZAXYGOJO",  # Nickname
        ...
        # Use ThreadPoolExecutor to avoid blocking the async loop
                        ...
                        if inPuTMsG.strip().startswith('/roommsg'):
                            ...
                            if len(parts) < 3:
                                ...
                                try:
                                    # Get bot UID
                                    bot_uid = LoGinDaTaUncRypTinG.AccountUID if hasattr(LoGinDaTaUncRypTinG, 'AccountUID') else 1561796267
...
[FFFFFF]          ⚡ ZAXYGOJO FATHER OF DEVELOPER ⚡ 
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]ZAXYGOJO FATHER OF DEVELOPER ⚡ 
[FFD700]✨ Name on instagram : [FFFFFF] _armmaann._12❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> ZAXYGOJO ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "GOJO", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hᴇʏ Wᴇʟᴄᴏᴍᴇ ᴛᴏ Gᴏᴊᴏ Tᴄᴘ Bᴏᴛ ✨"
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]ZAXYGOJO(SPIDEY$RICH)
...
async def MaiiiinE():
    Uid , Pw = '4339073071','GOJO_FATHER_OF_DEVELOPER_H0JL3_CB4R5'
    ...
    os.system('clear')
    print(render('GOJO', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 GOJO BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using ZAXYGOJO")
    sys.exit(0)
